...
import { addResult } from '../store/actions/AddResult';
...
export default function Data() {
    ...
    useEffect(() => {
        ...
        return () => {
            console.clear();
            document.removeEventListener("scroll", requestAnimationEvent);
            dispatch(addResult(scrollPosition, "data")); // scroll position when leaving the page is then stored in arr in state
        };
    });

    const listenToScrollEvent = () => {
        document.addEventListener("scroll", requestAnimationEvent)
    };

    const requestAnimationEvent = () => {
    ...
    const calculateScrollDistance = () => {
        ...
        const newscrollPosition = (scrollTop / totalDocScrollLength * 100);
    ...
    return (
        <div className='data'>
            ...
            <article className='post'>
                ...
                or avoids pleasure itself, because it is pleasure, but because those who do not know how to pursue pleasure rationally encounter consequences that are extremely painful. Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because it is pain,
                but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some advantage from it? But who has any right to find fault with a man who chooses 
            ...
            <article className='post'>
                ...
                Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut
